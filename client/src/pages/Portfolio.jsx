...
const s = {
  ...
  qtyBtn: { width: 38, height: 38, background: "rgba(255,68,102,0.08)", border: "1px solid rgba(255,68,102,0.15)", borderRadius: 9, color: "#ff4466", fontSize: "1.2rem", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontFamily: "'Syne', sans-serif" },
  qtyInput: { flex: 1, textAlign: "center", padding: "0.625rem", background: "rgba(0,0,0,0.4)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 9, color: "#fff", fontSize: "1rem", fontWeight: 800, outline: "none", fontFamily: "'Syne', sans-serif" },
